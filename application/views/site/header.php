			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li><a href="<?php echo base_url('khuyen-mai'); ?>">DISCOUNT</a></li>
			       </ul>
			      <ul class="nav navbar-nav navbar-right">
			        ...
			        <?php }else{ ?>
						<li class="dropdown">
				          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Welcome: <?php echo $user->name; ?><span class="caret"></span></a>
