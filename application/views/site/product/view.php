	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
		...
		<div class="panel panel-info " style="margin-bottom: 15px">
		  <div class="panel-heading">
		    <h3 class="panel-title">View product detail</h3>
		  </div>
		  <div class="panel-body">
		  	...
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		  		...
		  		<?php 
		  			if ($product->discount > 0) {
		  				...
		  				?><p>Price: <strong><del><?php echo number_format($product->price) ?> VND</del></strong></p>
		  				<p>Sale: <span style="font-weight: bold;color: green"><?php echo number_format($price_new); ?> VND</span></p>
		  			<?php }else{ ?>
		  				<p>Giá: <span style="font-weight: bold;color: green"><?php echo number_format($product->price); ?> VND</span></p> <?php
		  			}
		  		?>
		  		<p>Views: <?php echo $product->view; ?></p>
		  		<p> Rate &nbsp;
		  		<?php $raty_tb = $product->rate_total/$product->rate_count; ?>
                       ...
                       | Total: <b  class='rate_count'><?php echo $product->rate_count; ?></b>
				</p>
		  	...
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
		  		...
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			...
		  			<p style="color:red">On-time</p>
		  		</div>
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/services.png" alt="">
		  			<p style="color:red">3 days return</p>
		  		</div>
		  	</div>
		  </div>
		</div>
