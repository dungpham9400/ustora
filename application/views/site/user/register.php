				...
				<div class="panel panel-info ">
				  ...
				  <div class="panel-body">
					  ...
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Fullname</label>
					    <div class="col-sm-4">
					  ...
					  <div class="form-group">
					    <label for="inputEmail3" class=" col-sm-offset-2 col-sm-2 control-label">Repeat password</label>
					    <div class="col-sm-4">
					  ...
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Address</label>
					    <div class="col-sm-4">
					  ...
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Phone number</label>
					    <div class="col-sm-4">
