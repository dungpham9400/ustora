...
class Catalog extends MY_Controller {
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run()) {
				...
				if ($this->catalog_model->create($data)) {
					$this->session->set_flashdata('message_success', 'Add category successfully');
				}else{
					$this->session->set_flashdata('message_fail', 'Fail to add category');
				}
	...
	public function del()
	{
		...
		if ($this->catalog_model->delete($id)) {
			$this->session->set_flashdata('message_success', 'Delete category successfully');
		}else{
